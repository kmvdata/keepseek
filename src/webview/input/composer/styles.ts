...
export const composerControlsStylesFragment: WebviewFragment = {
  ...
  source: `
    ...
    .composer.is-goal-mode .composer-input-inner {
      border-color: var(--vscode-textLink-foreground, var(--vscode-focusBorder));
      box-shadow: inset 3px 0 0 var(--vscode-textLink-foreground, var(--vscode-focusBorder));
    }

    .composer.is-goal-locked .rich-input {
      opacity: .62;
      cursor: default;
    }
