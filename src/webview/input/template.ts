        ...
        <div class="composer-input-inner">
          ...
          <div class="composer-toolbar" aria-label="Chat input toolbar" data-i18n-aria-label="chatInputToolbar">
            ...
            <div class="composer-toolbar-right">
              <div id="contextProgress" class="context-progress" role="status" tabindex="0" aria-describedby="contextProgressTooltip" aria-label="背景信息窗口（当前会话估算）：0% 已使用（剩余 100%）。已估算 0 标记，共 1M">
                ...
                <span id="contextProgressTooltip" class="context-progress-tooltip" role="tooltip">
                  <span id="contextProgressTitle">背景信息窗口（当前会话估算）：</span>
