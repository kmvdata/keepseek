...
export const WEBVIEW_TRANSLATIONS: Record<KeepseekLanguage, TranslationCatalog> = {
  'zh-CN': {
    ...
    send: '发送',
    contextWindowEstimateTitle: '背景信息窗口（估算）：',
    contextWindowPercentLine: '{usedPercent}% 已用（剩余 {remainingPercent}%）',
    contextWindowTokensLine: '已用 {usedTokens} 标记，共 {maxTokens}',
    contextWindowProgressLabel: '背景信息窗口（估算）：{usedPercent}% 已用（剩余 {remainingPercent}%）。已用 {usedTokens} 标记，共 {maxTokens}',
    commandMenu: '命令菜单',
    switchModel: '切换模型...',
  ...
  en: {
    ...
    send: 'Send',
    contextWindowEstimateTitle: 'Context window (estimated):',
    ...
    contextWindowProgressLabel: 'Context window estimate: {usedPercent}% used, {remainingPercent}% remaining. {usedTokens} tokens used of {maxTokens}',
