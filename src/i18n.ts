...
export const WEBVIEW_TRANSLATIONS: Record<KeepseekLanguage, TranslationCatalog> = {
  'zh-CN': {
    ...
    settingsApiKeyTitle: 'API 与预算',
    settingsApiKeyDescription: 'API key、输出和 Agent 预算设置',
    ...
    apiDialogLabel: 'KeepSeek 设置',
    apiDialogTitle: 'KeepSeek 设置',
    apiDialogDesc: '配置 DeepSeek API 与 Agent 执行预算。',
    settingsMaxTokensLabel: '最大输出 tokens',
    settingsMaxTokensHint: '0 表示使用服务商默认值',
    settingsAgentBudgetTitle: 'Agent 执行预算',
    ...
    settingsMaxRunMsLabel: '最大运行时间（毫秒）',
    settingsMaxRunMsHint: '默认 600000（10 分钟）；0 表示不启用总时长上限',
    settingsToolResultTokenBudgetLabel: '工具结果 token 预算',
    settingsToolResultTokenBudgetHint: '默认 0，按模型上下文窗口自动估算',
  ...
  en: {
    ...
    settingsApiKeyTitle: 'API and budgets',
    settingsApiKeyDescription: 'API key, output, and agent budget settings',
    ...
    apiDialogLabel: 'KeepSeek Settings',
    apiDialogTitle: 'KeepSeek Settings',
    apiDialogDesc: 'Configure the DeepSeek API and agent execution budgets.',
    settingsMaxTokensLabel: 'Max output tokens',
    settingsMaxTokensHint: '0 uses the provider default',
    settingsAgentBudgetTitle: 'Agent execution budgets',
    ...
    settingsMaxRunMsLabel: 'Max run time (ms)',
    settingsMaxRunMsHint: 'Default 600000 (10 minutes). 0 disables the total run-time cap.',
    settingsToolResultTokenBudgetLabel: 'Tool-result token budget',
    settingsToolResultTokenBudgetHint: 'Default 0 automatically derives the budget from the model context window.',
    ...
    cancel: 'Cancel',
    save: 'Save',
    apiSettingsSaved: 'Settings saved',
...
const EXTENSION_TRANSLATIONS: Record<KeepseekLanguage, TranslationCatalog> = {
  'zh-CN': {
    ...
    apiSettingsSaved: 'KeepSeek 设置已保存。',
  ...
  en: {
    ...
    apiSettingsSaved: 'KeepSeek settings saved.',
